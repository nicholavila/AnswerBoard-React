...
const CreateSubTopic = () => {
  ...
  useEffect(() => {
    ...
    ; (async () => {
      ...
      let lastOrder;
      if (data.length > 0 && data[0].subjects.length > 0 && data[0].subjects[0].modules.length > 0 && data[0].subjects[0].modules[0].topics.length > 0 && data[0].subjects[0].modules[0].topics[0].subTopics.length > 0)
        lastOrder = data[0].subjects[0].modules[0].topics[0].subTopics[0].no;
      else
        lastOrder = 0;
