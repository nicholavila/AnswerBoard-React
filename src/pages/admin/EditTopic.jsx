...
const EditSubject = () => {
    ...
    const [topic, setTopic] = useState({ no: "", year: "", subject: "", name: "", description: "" });
    const validationSchema = yup.object({
        ...
        subject: yup.string('Choose a subject.').required('Must be valid.'),
    ...
    const setComboData = async (yearData) => {
        ...
        if (data.status) {
            ...
            // Set Subjects
            let yearIdx = yearData.findIndex(year => year._id === data.data.module.subject.year._id);
            setSubjects(yearData[yearIdx].subjects);

            // Set Modules
            let subjectIdx = yearData[yearIdx].subjects.findIndex(subject => subject._id === data.data.module.subject._id);
