...
const MembershipPricing = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (rowData, idx) => Number(rowData.subject_nums) > 3 ? '3+ Subjects' : + Number(rowData.subject_nums) + ' Subjects'
    },
    {
      key: 'price',
      name: 'Price',
  ...
  return (
    <Card className='membership-pricing-container'>
      ...
      <Modal show={isNew} onHide={() => setIsNew(false)}
        ...
        centered>
        <Modal.Header>
          <Modal.Title><h1>New membership price</h1></Modal.Title>
        </Modal.Header>
        <Formik
              ...
              <Modal.Body>
                ...
                <Form.Group className='mb-3'>
                  ...
                  >
                    ...
                    <option value='4'>3+ subjects</option>
                  </Form.Select>
                  <Form.Control.Feedback type='invalid'>
                    {errors.subject_nums}
                  </Form.Control.Feedback>
      ...
      <Modal show={isEdit} onHide={() => setIsEdit(false)}
        ...
        centered>
        <Modal.Header>
          <Modal.Title><h1>Edit membership price</h1></Modal.Title>
        </Modal.Header>
        <Formik
          validationSchema={validationSchema}
          onSubmit={onUpdate}
      ...
      <CModal visible={isDel} onClose={() => setIsDel(false)}>
        <CModalHeader>
        ...
        <CModalFooter>
          ...
          <CButton color="danger" onClick={() => setIsDel(false)}><i className="fa fa-thumbs-down"></i> Cancel</CButton>
        </CModalFooter>
      </CModal>
    </Card>
  )
